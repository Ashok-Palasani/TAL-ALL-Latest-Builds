...
namespace CalOEEDaily
{
    public partial class Form1 : Form
    {
        ...
        public Form1()
        {
            ...
            try
            {
                IntoFile("StartTime " + sDate);
                CalculateOEEForYesterday(sDate, eDate);
                IntoFile("EndTime " + eDate);
                ...
                foreach (var macrow in machineData)
                {
                    ...
                    try
                    {
                        ...
                        if (OEEDataPresent.Count == 0)
                        {
                            ...
                            using (i_facility_talEntities dbLoss = new i_facility_talEntities())
                            {
        ...
        public async Task<double> GetSummationOfSCTvsPP(string UsedDateForExcel, int MachineID)
        {
           ...
           // UsedDateForExcel = "2018-12-01";
            ...
            //using (i_facility_talEntities dbhmi = new i_facility_talEntities())
            //{
        ...
        public async Task<double> GetGreen(string UsedDateForExcel, DateTime StartTime, DateTime EndTime, int MachineID)
        {
            ...
            using (MsqlConnection mc = new MsqlConnection())
            {
                ...
                String query1 = "SELECT StartTime,EndTime,ModeID From ["+ MsqlConnection.ServerName + "].[" + MsqlConnection.Schema +"].tblmode WHERE MachineID = '" + MachineID + "' and CorrectedDate = '" + UsedDateForExcel + "' and ColorCode = 'green'  and"
        ...
        public async Task<double> GetSettingTimeForWO(string UsedDateForExcel, int MachineID, DateTime StartTime, DateTime EndTime)
        {
            ...
            using (MsqlConnection mc = new MsqlConnection())
            {
                ...
                mc.open();
                String query1 = "SELECT StartDateTime,EndDateTime,LossID From ["+ MsqlConnection.ServerName + "].[" + MsqlConnection.Schema +"].tbllossofentry WHERE MachineID = '" + MachineID + "' and CorrectedDate = '" + UsedDateForExcel + "' and MessageCodeID IN ( " + SettingIDsString + " ) and DoneWithRow = 1  and "
        ...
        public async Task<double> GetSelfInsepectionForWO(string UsedDateForExcel, int MachineID, DateTime StartTime, DateTime EndTime)
        {
            ...
            {
                mc.open();
                String query1 = "SELECT StartDateTime,EndDateTime,LossID From ["+ MsqlConnection.ServerName + "].[" + MsqlConnection.Schema +"].tbllossofentry WHERE MachineID = '" + MachineID + "' and CorrectedDate = '" + UsedDateForExcel + "' and MessageCodeID IN ( " + SelfInspectionid + " ) and DoneWithRow = 1  and "
                    + "( StartDateTime <= '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( ( EndDateTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( EndDateTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' or   EndDateTime > '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' )  ) ) or "
                    + " ( StartDateTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( StartDateTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' ) ))";
                SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                da1.Fill(lossesData);
        ...
        public async Task<double> GetAllLossesTimeForWO(string UsedDateForExcel, int MachineID, DateTime StartTime, DateTime EndTime)
        {
            ...
            using (MsqlConnection mc = new MsqlConnection())
            {
                ...
                String query1 = "SELECT StartDateTime,EndDateTime,LossID From ["+ MsqlConnection.ServerName + "].[" + MsqlConnection.Schema +"].tbllossofentry WHERE MachineID = '" + MachineID + "' and DoneWithRow = 1  and "
                    + "( StartDateTime <= '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( ( EndDateTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( EndDateTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' or   EndDateTime > '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' )  ) ) or "
                    + " ( StartDateTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( StartDateTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' ) ))";
                SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                da1.Fill(lossesData);
        ...
        public async Task<double> GetDownTimeBreakdownForWO(string UsedDateForExcel, int MachineID, DateTime StartTime, DateTime EndTime)
        {
            ...
            {
                mc.open();
                String query1 = "SELECT StartTime,EndTime From ["+ MsqlConnection.ServerName + "].[" + MsqlConnection.Schema +"].tblbreakdown WHERE MachineID = '" + MachineID + "' and CorrectedDate = '" + UsedDateForExcel + "' and DoneWithRow = 1  and "
                    + "( StartTime <= '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( ( EndTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( EndTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' or   EndTime > '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' )  ) ) or "
                    + " ( StartTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( StartTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' ) ))";
                SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                da1.Fill(lossesData);
        ...
        public async Task<double> GetBlue(string UsedDateForExcel, DateTime StartTime, DateTime EndTime, int MachineID)
        {
            ...
            {
                mc.open();
                String query1 = "SELECT StartTime,EndTime,ModeID From ["+ MsqlConnection.ServerName + "].[" + MsqlConnection.Schema +"].tblmode WHERE MachineID = '" + MachineID + "' and CorrectedDate = '" + UsedDateForExcel + "' and ColorCode = 'blue'  and"
                   + "( StartTime <= '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( ( EndTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( EndTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' or   EndTime > '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' )  ) ) or "
                   + " ( StartTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( StartTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' ) ))";
        ...
        public async Task<double> GetMinorLossForWO(string UsedDateForExcel, int MachineID, DateTime StartTime, DateTime EndTime)
        {
            ...
            {
                mc.open();
                String query1 = "SELECT StartTime,EndTime,ModeID From ["+ MsqlConnection.ServerName + "].[" + MsqlConnection.Schema +"].tblmode WHERE MachineID = '" + MachineID + "' and CorrectedDate = '" + UsedDateForExcel + "' and ColorCode = 'yellow' and  DurationInSec < 120 and"
                   + "( StartTime <= '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( ( EndTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( EndTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' or   EndTime > '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' )  ) ) or "
                   + " ( StartTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( StartTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' ) ))";
        ...
        public void DeletePrvDaysDataFromLiveDPS()
        {
            try
            {
                ...
                using (i_facility_talEntities dblivedps = new i_facility_talEntities())
                {
                                ...
                                if (isSingleWo == 0)
                                {
                                    ...
                                    try
                                    {
                                        ...
                                        using (MsqlConnection mcInsertRows = new MsqlConnection())
                                        {
                                            ...
                                            {
                                                mcInsertRows.open();
                                                //SqlCommand cmdInsertRows = new SqlCommand("INSERT INTO ["+ MsqlConnection.ServerName + "].[" + MsqlConnection.Schema +"].tblworeport " +
                        ...
                        foreach (var hmirow in HMIData)
                        {
                            ...
                            if (WODataPresent.Count == 0)
                            {
                                ...
                                foreach (var loss in LossesIDs)
                                {
                                    ...
                                    {
                                        mc.open();
                                        String query1 = "SELECT StartDateTime,EndDateTime,LossID From ["+ MsqlConnection.ServerName + "].[" + MsqlConnection.Schema +"].tbllossofentry WHERE MachineID = '" + MachineID + "' and CorrectedDate = '" + CorrectedDate + "' and MessageCodeID = '" + lossID + "' and DoneWithRow = 1  and "
                                            + "( StartDateTime <= '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( ( EndDateTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( EndDateTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' or   EndDateTime > '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' )  ) ) or "
                                            + " (  StartDateTime > '" + StartTime.ToString("yyyy-MM-dd HH:mm:ss") + "' and ( StartDateTime < '" + EndTime.ToString("yyyy-MM-dd HH:mm:ss") + "' ) ))";
                                        SqlDataAdapter da1 = new SqlDataAdapter(query1, mc.msqlConnection);
                                        da1.Fill(lossesData);
                                    ...
                                    if (duration > 0)
                                    {
                                        ...
                                        if (level == 3)
                                        {
                                            ...
                                            using (MsqlConnection mcInsertRows = new MsqlConnection())
                                            {
                                                ...
                                                {
                                                    mcInsertRows.open();
                                                    SqlCommand cmdInsertRows = new SqlCommand("INSERT INTO ["+ MsqlConnection.ServerName + "].[" + MsqlConnection.Schema +"].tblwolossess "
