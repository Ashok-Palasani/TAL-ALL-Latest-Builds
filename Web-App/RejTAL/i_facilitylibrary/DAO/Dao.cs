...
namespace i_facilitylibrary.DAO
{
    public class Dao : ConnectionFactory
    {
        ...
        public tbllivelossofentry GetPoweroffDetails(int MachineID, string CorrectedDate)
        {
            ...
            try
            {
                ...
                string qry = "SELECT * FROM " + databaseName + ".[tbllivelossofentry] WHERE MachineID =" + MachineID + " and CorrectedDate='" + CorrectedDate + "' and EndDateTime IS NULL and MessageCodeID ='10046'";
        ...
        public List<tblddl> GetddlDetails(string WONo, string Part, string Operation)
        {
            ...
            try
            {
                ...
                string qry = "SELECT * FROM "+databaseName+".[tblddl] WHERE IsCompleted = 0 and WorkOrder='" + WONo + "' and PartName ='" + Part + "' and OperationNo != " + Operation + " order by WorkOrder,PartName,OperationNo";
        ...
        public int UpdateLiveHMIScreenDetailsD1(int HMIID, string value)
        {
            int res = 0;
            try
            {
                ...
                string qry = "update " + databaseName + ".[tbllivehmiscreen] set RejectionQuantity = " + value + " WHERE HMIID =" + HMIID + "";
                res = lista.update(qry, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
            {
        ...
        public tblddl GetddlDetails3(string woNo, string partNo, string opNo)
        {
            ...
            try
            {
                ...
                string qry = "SELECT * FROM "+databaseName+".[tblddl] WHERE WorkOrder='" + woNo + "' and PartName='" + partNo + "' and OperationNo ='" + opNo + "'";
                ddl = lista.GetFirstOrDefault(qry, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
            {
        ...
        public tblddl GettblddlDetails(string WorkOrder, string Part, string Operation)
        {
            ...
            try
            {
                ...
                string qry = "SELECT * FROM "+databaseName+".[tblddl] WHERE WorkOrder ='" + WorkOrder + "' and PartName='" + Part + "' and OperationNo ='" + Operation + "' and IsCompleted = 1";
                liveHMI = lista.GetFirstOrDefault(qry, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
            {
        ...
        public tbllossescode GetLossDet2(int losscodeid)
        {
            ...
            try
            {
                ...
                string query = "SELECT * from " + databaseName + ".tbllossescodes WHERE LossCodeID =" + losscodeid + "And LossCodeID != '" + 7 + "'";
                ddldet = lista.GetFirstOrDefault(query, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
            {
        ...
        public int UpdateLiveHMIScreenDetailsD1(DateTime? Time, int Status, int isWorkInProgress, int HMIID)
        {
            ...
            try
            {
                ...
                DateTime timee = Convert.ToDateTime(Time);
                string datee = timee.ToString("yyyy-MM-dd HH:mm:ss");
                string qry = "UPDATE " + databaseName + ".[tbllivehmiscreen] set Status =" + Status + ",isWorkInProgress =" + isWorkInProgress + ",Time='" + datee + "'WHERE HMIID =" + HMIID + "";
                res = lista.update(qry, _connectionFactory.GetConnection);
            }
            catch (Exception ex)
            {
        ...
        public int UpdateLossofentriesDetails1(int hmiid, DateTime Time)
        {
            ...
            {
                Repository<tbllivehmiscreen> lista = new Repository<tbllivehmiscreen>();
                string datee = Time.ToString("yyyy-MM-dd HH:mm:ss");
                string query = "Update  " + databaseName + ".tbllivehmiscreen SET Status = 2,isWorkInProgress = 1,SplitWO = 'No',Time='" + datee + "' WHERE HMIID =" + hmiid + " ";
                res = _connectionFactory.GetConnection.ExecuteAsync(query).Result;
            }
            catch (Exception ex)
            {
