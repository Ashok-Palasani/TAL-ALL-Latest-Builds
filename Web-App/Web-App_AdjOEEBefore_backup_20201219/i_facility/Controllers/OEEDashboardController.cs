...
namespace i_facility.Controllers
{
    ...
    public class OEEDashboardController : Controller
    {
        ...
        {
            IntoFile("fromdate :" + fromdate);
            IntoFile("todate :" + todate);
            _conn = new ConnectionFactory();
            obj1 = new Dao(_conn);
            obj = new Dao1(_conn);
            DateTime UsedDateForExcel = Convert.ToDateTime(fromdate);
            ...
            string datte = fromdate.ToString("yyyy-MM-dd HH:mm:ss");
            string dateend = todate.ToString("yyyy-MM-dd HH:mm:ss");

            IntoFile("start date : " + datte + "enddate :" + dateend);
            ...
            if (TimeType == "Today")
            {
                ...
                foreach (var WCRow in getWC)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday a where WCID = " + WCRow.WCID + " and StartDate Between '" + datte + "' AND '" + dateend + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday b where WCID = " + WCRow.WCID + " and StartDate Between '" + datte + "' AND '" + dateend + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday c where WCID = " + WCRow.WCID + " and StartDate Between '" + datte + "' AND '" + dateend + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday d where WCID = " + WCRow.WCID + " and StartDate Between '" + datte + "' AND '" + dateend + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariablestoday e where WCID = " + WCRow.WCID + " and StartDate Between '" + datte + "' AND '" + dateend + "' " +
                                             ") f order by f.lossname desc";
                    DataTable GetDistinctLossDT = new DataTable();
                    using (MsqlConnection mc = new MsqlConnection())
                    {
            ...
            else if (TimeType == "GodHours" || TimeType == "NoBlue")
            {
                ...
                foreach (var WCRow in getWC)
                {
                    ...
                    string GetDistinctLossQuery = "Select Distinct f.lossname from" +
                                             "(" +
                                             "Select Distinct a.Loss1Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables a where WCID = " + WCRow.WCID + " and StartDate Between '" + datte + "' AND '" + dateend + "' " +
                                             "Union All " +
                                             "Select Distinct b.Loss2Name  as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables b where WCID = " + WCRow.WCID + " and StartDate Between '" + datte + "' AND '" + dateend + "' " +
                                             "Union All " +
                                             "Select Distinct c.Loss3Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables c where WCID = " + WCRow.WCID + " and StartDate Between '" + datte + "' AND '" + dateend + "' " +
                                             "Union All " +
                                             "Select Distinct d.Loss4Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables d where WCID = " + WCRow.WCID + " and StartDate Between '" + datte + "' AND '" + dateend + "' " +
                                             "Union All " +
                                             "Select Distinct e.Loss5Name as lossname from "+ MsqlConnection.DbName + ".tbloeedashboardvariables e where WCID = " + WCRow.WCID + " and StartDate Between '" + datte + "' AND '" + dateend + "' " +
                                             ") f order by f.lossname desc";
                    IntoFile("query : " + GetDistinctLossQuery);
                    MsqlConnection mc = new MsqlConnection();
                    mc.open();
                    SqlDataAdapter GetDistinctLossDA = new SqlDataAdapter(GetDistinctLossQuery, mc.msqlConnection);
                    DataTable GetDistinctLossDT = new DataTable();
